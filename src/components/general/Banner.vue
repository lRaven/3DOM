    ...
    <div class="banner__container center">
      <div class="banner__left">
        <div class="banner__order">
          ...
          <p>
            Вам предоставляется уникальная возможность приобрести квартиру по
            программе «Trade-In». Поменяем ваше жилье на квартиру в новостройке.
          </p>
        ...
        <div class="banner__watch">
          ...
          <div class="banner__watch-left">
            <img src="img/bannerGeneral/banner-img2.png" alt="govno" />
          </div>
          <div class="banner__watch-right">
            <p>
              Квартиры
              <br />
              для молодых семей, со встроенной мебелью,
              <br />
              санузлом
              <br />
              и кухней
            </p>
            <btn text="Смотреть" class="blue"></btn>
          </div>
        </div>
      </div>
      <div class="banner__right">
        ...
        <div class="banner__right-content">
          ...
          <div class="banner__right-text">
            ...
            <span>Стандарт «Под ключ»</span>
            <span>Комфорт «Под ключ»</span>
          </div>
          <div class="btn">
            <btn text="Заказать отделку" class="white"></btn>
          </div>
        </div>
      </div>
    </div>
...
.banner {
  ...
  &__order {
    ...
    &-decoration {
      ...
      padding: 2.2rem 2.6rem 1.7rem 2.6rem;
      background-color: var(--light-blue);
    }
  }
  &__watch {
    display: grid;
    grid-template-columns: 45rem 17.5rem;
