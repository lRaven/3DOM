...
<script>
	...
	import { removeBooking } from "../../api/booking";
	...
	export default {
		...
		data() {
			return {
				apartments: store.getters.BOOKING,
				id: null,
			};
		},
		methods: {
			...
			//* получение списка квартир из vuex
			getApartments() {
				this.apartments = store.getters.BOOKING;
			},
		},
		mounted() {
			this.studioRename();
